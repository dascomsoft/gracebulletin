...
const ReportPreview = ({ formData, annualAverage, onBack, isEnglish, onFinalize }) => {
  ...
  const handleDownload = () => {
    // Ouvrir une nouvelle fenêtre avec le contenu formaté pour impression PDF
      ...
      <body>
        <div class="header">
          <div style="text-align: left;">
            <div style="font-weight: bold;">RÉPUBLIQUE DU CAMEROUN</div>
        ...
        <div class="school-name">
          ...
          <strong style="font-size: 24px;">${isEnglish ? 'SCHOOL REPORT' : 'BULLETIN SCOLAIRE'}</strong>
        </div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr class="total-row">
              <td><strong>${isEnglish ? 'TOTAL' : 'TOTAL'}</strong></td>
              <td>${(
        ...
        <div class="signature-section">
          <div style="text-align: center;">
            ...
            <div style="margin-top: 40px; border-top: 1px solid #000; width: 200px; display: inline-block;">
        ...
        <div class="footer">
          <div>
            <p>${isEnglish ? 'Telephone: (+237) 696-308-503 / WhatsApp: 651989899' : 'Téléphone: (+237) 696-308-503 / WhatsApp: 651989899'}</p>
            <p>${isEnglish ? 'Headquarters: YAOUNDÉ - AKOK-NDOE-2 (Mbouda neighborhood, opposite the mini market)' : 'Siège social: YAOUNDÉ - AKOK-NDOE-2 (Quartier Mbouda, face au mini marché)'}</p>
          </div>
          <div>
            <p>${isEnglish ? 'Opening authorization: N° 61/JL/23/A/MINEDUB/SG/DSEPB/SDRA/DR 05 JANUARY 2025' : 'Arrêté d\'ouverture: N° 61/JL/23/A/MINEDUB/SG/DSEPB/SDRA/DR 05 JANVIER 2025'}</p>
          </div>
        </div>
      </body>
      </html>

...
//   return (
//     <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-blue-100 to-purple-200 px-4 sm:px-6 lg:px-8">
//       <form
...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // URL CORRIGÉE : votre serveur local

...
export default function FrancophoneSection() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 via-emerald-100 to-teal-50 p-6">
      <div className="bg-white shadow-2xl rounded-2xl p-10 w-full max-w-md text-center">
        ...
        <div className="flex flex-col gap-4">
          <button
            ...
            className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white py-3 rounded-xl font-semibold shadow-md hover:scale-105 transition-transform"
          >
            Maternelle
          </button>

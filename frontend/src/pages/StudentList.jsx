...
// const handleCreateBulletin = (studentId, e) => {
//     e.stopPropagation(); // Empêche le clic sur la carte entière
    
//     // Naviguer vers le formulaire de bulletin avec l'ID de l'élève
//     navigate(`/bulletin-form/${studentId}`, {
//         state: { 
//             studentId: studentId,
...
//             // La photo est maintenant dans public/ avec un nom temporaire
//             photoPath = uploadData.photo_path; // Ex: "temp-photo-123456789.jpeg"
...
//             photo_path: photoPath, // Chemin temporaire du fichier dans public/
...
//     console.log('📸 Chargement photo:', photoPath); // Debug
//     // URL corrigée

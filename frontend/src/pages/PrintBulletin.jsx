...
//                     ) : (
//                         <div style={{ fontSize: '7px', textAlign: 'center' }}>No Photo</div>
//                     )}
//                 </div>
...
//                         <th style={{ border: '1px solid #000', padding: '2px', width: '25%' }}>Skills</th>
//                         <th style={{ border: '1px solid #000', padding: '2px', width: '35%' }}>Description</th>
//                         <th style={{ border: '1px solid #000', padding: '2px', textAlign: 'center' }}>Eval</th>
...
//                         <th style={{ border: '1px solid #000', padding: '2px', textAlign: 'center' }}>Appreciation</th>
//                     </tr>
//                 </thead>
//                 <tbody>
//                     {[
...
//                     <div style={{ fontWeight: 'bold', textAlign: 'center', marginBottom: '3px' }}>Appreciation Legend</div>
...
//                 {/* Periods */}
//                 <div style={{ flex: 1, border: '1px solid #000', padding: '5px', fontSize: '8px' }}>
//                     <div style={{ fontWeight: 'bold', textAlign: 'center', marginBottom: '3px' }}>Periods</div>
...
//                         <div style={{ textAlign: 'center' }}>Avg: {averages.a1}</div>
//                         <div style={{ textAlign: 'center' }}>Avg: {averages.a2}</div>
//                         <div style={{ textAlign: 'center' }}>Avg: {averages.a3}</div>
...
//                     <div style={{ fontWeight: 'bold', textAlign: 'center', marginBottom: '3px' }}>Summary</div>
//                     <div style={{ textAlign: 'center', marginBottom: '5px' }}>
//                         <div style={{ fontSize: '7px' }}>Overall Average</div>
//                         <div style={{ fontSize: '10px', fontWeight: 'bold' }}>{overallAvg}</div>
//                     </div>
//                     <div>
//                         <div style={{ fontSize: '7px' }}>Appreciation:</div>
...
//                     </div>
//                     <div style={{ marginTop: '3px' }}>
//                         <div style={{ fontSize: '7px' }}>Decision:</div>
//                         <div style={{ border: '1px solid #000', padding: '2px', minHeight: '15px', textAlign: 'center' }}>
//                             {summary.decision || "-"}
//                         </div>
//                     </div>
...
//                             <div style={{ fontWeight: 'bold', fontSize: '7px' }}>{role}'s Visa</div>

...
//             return 'maternelle';
//         } else if (className.includes('nursery')) {
//             // SEUL CHANGEMENT ICI : nursery -> new-nursery
//             return 'new-nursery';
//         }
...
const StudentDashboard = () => {
    ...
    const handleCreateBulletin = (trimestre) => {
        ...
        const bulletinType = getBulletinType(student);
        console.log('📝 Création bulletin:', { bulletinType, studentId: student.id, trimestre });
    ...
    const handleContinueBulletin = (trimestre) => {
        ...
        const bulletinType = getBulletinType(student);
        console.log('✏️ Continuation bulletin:', { bulletinType, bulletinId, trimestre });

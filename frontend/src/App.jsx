...
// IMPORTANT: Remplacer BrowserRouter par HashRouter
import { HashRouter as Router, Routes, Route, useNavigate, Navigate } from "react-router-dom";
//      ^^^^^^^^^^^^^  ← Ce changement est crucial pour Windows (mode file://)
...
// ANCIEN IMPORT (commenté pour référence)
// import BulletinNurseryForm from './pages/BulletinNurseryForm';
// NOUVEL IMPORT
import NewNurseryBulletin from './pages/NewNurseryBulletin';
...
import PrintNewNurseryBulletin from './pages/PrintNewNurseryBulletin';
import StudentsListGeneral from './pages/StudentsListGeneral';

import PrimaireFrancophoneNiveau2 from './pages/PrimaireFrancophoneNiveau2';
import BulletinFormLevel2 from './pages/BulletinFormLevel2';
...
//  NIVEAU & LEVELS
import PrimaryLevels from './components/PrimaryLevels';
import LevelClasses from './components/LevelClasses';

// Composant 404 (déjà correct)
function NotFound() {
...
function App() {
  return (
    <Router>  {/* Maintenant c'est HashRouter */}
      <Routes>
        ...
        <Route path="/bulletin/anglophone/level1/:studentId" element={<BulletinForm />} />
        <Route path="/bulletin/anglophone/level2/:studentId" element={<BulletinFormLevel2 />} />
        <Route path="/bulletin/anglophone/level3/:studentId" element={<BulletinFormLevel2 />} />
        ...
        <Route path="/bulletin/francophone/niveau1/:studentId" element={<PrimaireFrancophone />} />

        <Route path="/bulletin/francophone/niveau2/:studentId" element={<PrimaireFrancophoneNiveau2 />} />
        <Route path="/bulletin/francophone/niveau3/:studentId" element={<PrimaireFrancophoneNiveau2 />} />
        {/* Maternelle */}
...
<Route path="/:section/primary/levels" element={<PrimaryLevels />} />
<Route path="/:section/primary/level/:levelId" element={<LevelClasses />} />


// NOUVEAU NURSERY - 22 matières
<Route path="/bulletin/new-nursery/:studentId" element={<NewNurseryBulletin />} />
<Route path="/bulletin/new-nursery/term1/:studentId" element={<NewNurseryBulletin />} />
<Route path="/bulletin/new-nursery/term2/:studentId" element={<NewNurseryBulletin />} />
<Route path="/bulletin/new-nursery/term3/:studentId" element={<NewNurseryBulletin />} />
        
        {/* NOUVEAU NURSERY - Avec le nouveau nom de fichier */}
        <Route path="/new-nursery/:studentId" element={<NewNurseryBulletin />} />
        <Route path="/new-nursery/term1/:studentId" element={<NewNurseryBulletin />} />
        <Route path="/new-nursery/term2/:studentId" element={<NewNurseryBulletin />} />
        <Route path="/new-nursery/term3/:studentId" element={<NewNurseryBulletin />} />
        
        {/* ANCIENNES ROUTES NURSERY (commentées pour éviter toute confusion)
        <Route path="/bulletin/nursery/:studentId" element={<NewNurseryBulletin />} />
        <Route path="/bulletin/nursery/term1/:studentId" element={<NewNurseryBulletin />} />
        <Route path="/bulletin/nursery/term2/:studentId" element={<NewNurseryBulletin />} />
        <Route path="/bulletin/nursery/term3/:studentId" element={<NewNurseryBulletin />} />
        */}
        ...
        {/* Route de l'ancien nursery (gardée pour compatibilité mais redirige vers le nouveau)
        <Route path="/nursery" element={<Navigate to="/new-nursery" replace />} />
        */}
        ...
        <Route path="/print-new-nursery-bulletin" element={<PrintNewNurseryBulletin />} />
